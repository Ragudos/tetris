import { tetromino_colors, tetromino_default_rotations, type KickData, type TetrominoNames, tetromino_config } from "../../../config/tetromino";
...
export default class Tetromino {
    ...
    rotate(dir: ROTATION_DIR): void {
        ...
        this.__rotation = (modulo(abs_new_rotation, tetromino_config.max_rotations)) * dir;
    }
