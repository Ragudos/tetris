...
interface TetrisEvents extends EventTarget {
    addEventListener<K extends keyof TetrisEventsMap>(type: K,
        listener: (this: TetrisEvents, ev: TetrisEventsMap[K]) => any, options?: boolean | AddEventListenerOptions): void;
    addEventListener(type: string, listener: EventListenerOrEventListenerObject, options?: boolean | AddEventListenerOptions): void;
    removeEventListener<K extends keyof TetrisEventsMap>(type: K,
        listener: (this: TetrisEvents, ev: TetrisEventsMap[K]) => any, options?: boolean | EventListenerOptions): void;
    removeEventListener(type: string, listener: EventListenerOrEventListenerObject, options?: boolean | EventListenerOptions): void;
}

class TetrisEvents extends EventTarget {
    $emit<K extends keyof TetrisEventsMap>(type: K, data: TetrisEventsData[K]): void {
